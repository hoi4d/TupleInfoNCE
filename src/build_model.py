...
from src.models.model import ESANetP4
from src.models.model_one_modality import ESANetOneModality
from src.models.resnet import ResNet


def build_model(args, n_classes,modality=0):
    ...
    if args.finetune is not None:
        ...
        for name, param in model.named_parameters():
            if 'encoder_rgb' in name or 'encoder_depth' in name or 'se_layer' in name or 'encoder_new' in name:
