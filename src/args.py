    ...
    def set_common_args(self):
        ...
        self.add_argument('--pretrained_scenenet', default='',
                          help='the path to the weights pretrained on '
                               'SceneNet')
        self.add_argument('--P4', default='',        #0316MODEL.pth
                          help='the path to the weights pretrained')
        ...
        # input dimensions
        self.add_argument('--batch_size', type=int, default=3,
                          help='batch size for training')
        self.add_argument('--batch_size_valid', type=int, default=2,
        ...
        # others
        self.add_argument('-j', '--workers', default=0, type=int, metavar='N',
