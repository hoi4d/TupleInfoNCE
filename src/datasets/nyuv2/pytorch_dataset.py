...
############################## ADD DATASET  ##########################
    ...
    def load_new(self, idx):
        return self._load(self.NEW_DIR, self._filenames[idx])
    def load_disturb(self, idx):
        return self._load(self.DISTURB_DIR, self._filenames[idx])
